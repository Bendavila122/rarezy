 ...
 * except the dashboard itself (and a certificate it just published, which
 * is reasonable to want to double-check). Anywhere else redirects straight
 * back to /admin. This is a UX boundary, not the security boundary — that's
...
export function AdminGate() {
  ...
  useEffect(() => {
    ...
    if (pathname === "/admin" || pathname.startsWith("/certificate/")) return;
