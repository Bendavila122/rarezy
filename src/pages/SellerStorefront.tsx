...
import { BadgeCheck, Facebook, Globe, Instagram, Mail, MapPin, Phone, Sparkles, TimerReset } from "lucide-react";
...
/** Same "Ending today" / "Listed today" tags as the demo-catalog cards, computed from the real competition's own timestamps. */
